...
public class ViewDragHelper {
    ...
    private ViewDragHelper(Context context, ViewGroup forParent, ViewDragHelper.Callback cb) {
        if(forParent == null) {
            ...
            this.refreshEdgeSize();
            ViewConfiguration vc = ViewConfiguration.get(context);
            this.mTouchSlop = vc.getScaledTouchSlop();
            this.mWearEdgeSizePx = resources.getDimensionPixelSize(dimen.drawer_view_edge_size);
    ...
    public void refreshEdgeSize() {
        if(this.mIsUiModeTypeWatch) {
            int edgeSizePx = (int)(0.2F * (float)this.mParentView.getHeight());
    ...
    public void captureChildView(View childView, int activePointerId) {
        if(childView.getParent() != this.mParentView) {
            String var3 = String.valueOf(this.mParentView);
            throw new IllegalArgumentException((new StringBuilder(95 + String.valueOf(var3).length())).append("captureChildView: parameter must be a descendant of the ViewDragHelper\'s tracked parent view (").append(var3).append(")").toString());
        } else {
    ...
    public boolean shouldInterceptTouchEvent(MotionEvent ev) {
        ...
        switch(action) {
            case 0:
                ...
                this.saveInitialMotion(var21, i, var23);
                var24 = this.findTopChildUnder((int)var21, (int)i);
            ...
            case 2:
                if(this.mInitialMotionX != null && this.mInitialMotionY != null) {
                    ...
                    for(int var22 = 0; var22 < pointerId; ++var22) {
                        var23 = MotionEventCompat.getPointerId(ev, var22);
                        float var25 = MotionEventCompat.getX(ev, var22);
                        float y = MotionEventCompat.getY(ev, var22);
